...
public class ChangeStore_ViewBinding implements Unbinder {
  private ChangeStore target;

  @UiThread
  public ChangeStore_ViewBinding(ChangeStore target, View source) {
    this.target = target;
    ...
    target.btnSelect = Utils.findRequiredViewAsType(source, R.id.btn_select, "field 'btnSelect'", Button.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    ChangeStore target = this.target;
