...
public class DealsAndPromotions_ViewBinding implements Unbinder {
  private DealsAndPromotions target;

  @UiThread
  public DealsAndPromotions_ViewBinding(DealsAndPromotions target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DealsAndPromotions target = this.target;
