...
public class LaundryStoreDetail_ViewBinding implements Unbinder {
  private LaundryStoreDetail target;

  @UiThread
  public LaundryStoreDetail_ViewBinding(LaundryStoreDetail target, View source) {
    this.target = target;
    ...
    target.iv_wash = Utils.findRequiredViewAsType(source, R.id.iv_wash, "field 'iv_wash'", ImageView.class);
    target.iv_dry_cleaning = Utils.findRequiredViewAsType(source, R.id.iv_dry_cleaning, "field 'iv_dry_cleaning'", ImageView.class);
    target.iv_tailoring = Utils.findRequiredViewAsType(source, R.id.iv_tailoring, "field 'iv_tailoring'", ImageView.class);
  ...
  @CallSuper
  public void unbind() {
    LaundryStoreDetail target = this.target;
    ...
    target.iv_wash = null;
    target.iv_dry_cleaning = null;
    target.iv_tailoring = null;
    target.llDate = null;
    target.llTime = null;
    target.tvDate = null;
