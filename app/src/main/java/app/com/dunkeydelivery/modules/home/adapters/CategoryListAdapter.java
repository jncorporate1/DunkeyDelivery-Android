...
public class CategoryListAdapter extends RecyclerView.Adapter {
    ...
    //constructor...
    public CategoryListAdapter(List<ItemBO> data, Context context, RecyclerView mRecyclerView) {
        this.dataSet = data;
    ...
    class ItemTypeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemTypeViewHolder(View itemView) {
            super(itemView);
            this.mParentFrame = (LinearLayout) itemView.findViewById(R.id.ll_root);
