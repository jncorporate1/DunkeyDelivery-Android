...
public class AddressListAdapter extends RecyclerView.Adapter {
    ...
    //constructor...
    public AddressListAdapter(List<Address> data, Context context, RecyclerView mRecyclerView) {
        this.dataSet = data;
    ...
    public void addItems(List<Address> streamBOs) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        Address address = dataSet.get(listPosition);
        if (holder instanceof ItemTypeViewHolder) {
            ItemTypeViewHolder itemTypeViewHolder = (ItemTypeViewHolder) holder;
            itemTypeViewHolder.tvTitle.setText(address.getFrequency());
            itemTypeViewHolder.tvSubTitle.setText(address.getAddress()+", "+address.getZipCode());
