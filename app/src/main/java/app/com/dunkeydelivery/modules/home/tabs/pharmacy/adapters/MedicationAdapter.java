package app.com.dunkeydelivery.modules.home.tabs.pharmacy.adapters;
...
public class MedicationAdapter extends RecyclerView.Adapter {
    private List<Medication> dataSet;
    Context mContext;
    int total_types;
    ...
    //constructor...
    public MedicationAdapter(List<Medication> data, Context context, RecyclerView mRecyclerView) {
        this.dataSet = data;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        Medication itemBO = dataSet.get(listPosition);
