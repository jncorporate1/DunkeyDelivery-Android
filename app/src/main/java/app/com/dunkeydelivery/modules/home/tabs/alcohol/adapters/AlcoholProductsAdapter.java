...
public class AlcoholProductsAdapter extends RecyclerView.Adapter {
    private List<ProductBO> dataSet;
    Context mContext;
    private boolean isGrid;

    //constructor...
    public AlcoholProductsAdapter(List<ProductBO> data, Context context, boolean isGrid) {
        this.dataSet = data;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        itemTypeViewHolder.tvPrice.setText("Price "+itemBO.getPriceInDouble());
        if(itemBO.getImage()!=null) {
