...
public class FilterOther extends ToolbarFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static FilterOther newInstance(boolean isShowDistance) {
        Bundle args = new Bundle();
        FilterOther fragment = new FilterOther();
    ...
    private void setUpData() {
        filter = FiltersOP.getFilters(Keys.Filter_OTHER);
        if (filter != null) {
    ...
    private FilterItem getFilterData() {
        ...
        if ((filter.getPriceRanges() == null || filter.getPriceRanges().trim().equals("")) &&
    ...
    public void refreshToolbar() {
        ...
        MenuItemImgOrStr menuItemTick = new MenuItemImgOrStr(R.drawable.tick, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FiltersOP.addFilter(Keys.Filter_OTHER, getFilterData());
        ...
        MenuItemImgOrStr menuItemReset = new MenuItemImgOrStr(R.drawable.refreshbtn, new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                Activities.goBackFragment(context, 1);
                FiltersOP.clearFilter(Keys.Filter_OTHER);
                clearFilter();
            }
